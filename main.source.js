...
function buildWeeklyTemplateStyleBlock(colors, sections) {
    ...
    return `
        ...
        @media (max-width: 700px) {
          .braincore-weekly .bc-weekly-nav-container { flex-wrap: wrap !important; gap: 12px !important; width: auto !important; max-width: 100% !important; }
        }
...
class MaterialSaveModal extends Modal {
    ...
    onOpen() {
        ...
        {
            const style = document.createElement("style");
            style.id = "bc-material-modal-styles-v5";
            ...
            .bc-mobile-force-top .modal-container:has(.bc-material-dialog){align-items:flex-start!important;justify-content:center!important;padding-top:0!important;padding-bottom:max(8px,env(safe-area-inset-bottom,0px))!important}
            .bc-mobile-force-top .bc-material-dialog,.bc-material-dialog.bc-mobile-adapted{width:96%!important;max-width:96%!important;margin:max(12px,env(safe-area-inset-top,0px)) auto 0!important;box-sizing:border-box!important;left:auto!important;right:auto!important;max-height:calc(100vh - 52px)!important;max-height:calc(100dvh - 52px)!important;overflow-y:auto!important;-webkit-overflow-scrolling:touch!important}
            ...
            .bc-mobile-force-top .bc-material-dialog .modal-close-button{top:8px!important;right:8px!important;width:44px!important;height:44px!important;transform:none!important;opacity:1!important;display:flex!important;align-items:center!important;justify-content:center!important;box-sizing:border-box!important}
            @media (max-width:480px){.bc-material-dialog{width:96%!important;max-width:96%!important;margin:max(12px,env(safe-area-inset-top,0px)) auto 0!important;max-height:calc(100vh - 52px)!important;max-height:calc(100dvh - 52px)!important;overflow-y:auto!important}.bc-material-modal{padding:16px 16px 20px}.bc-material-name-input{font-size:16px;min-width:0}.bc-material-target{padding-left:0}.bc-material-foot button{min-height:40px}}`;
            document.head.appendChild(style);
        }
...
.bc-row-icon{font-size:22px;display:flex;align-items:center;justify-content:center;line-height:1;color:var(--text-normal)}
.bc-row-icon svg{width:1.15em;height:1.15em;display:block;stroke:currentColor;fill:none}
.bc-row-item span{font-size:14px;margin-top:2px}
}@media (max-width:480px){
            .bc-modal-container .modal-close-button,.bc-capsule-modal .modal-close-button,.bc-material-dialog .modal-close-button{top:6px!important;right:6px!important;width:32px!important;height:32px!important;transform:none!important;opacity:.55!important;display:flex!important;align-items:center!important;justify-content:center!important;box-sizing:border-box!important;background:transparent!important;box-shadow:none!important;border:0!important}
            .bc-modal-container,.bc-capsule-modal{width:96%!important;max-width:96%!important;height:fit-content!important;min-height:0!important;flex:0 0 auto!important;margin:48px auto 8px!important;box-sizing:border-box!important;max-height:calc(100vh - 56px - var(--bc-kb-inset,0px))!important;max-height:calc(100dvh - 56px - var(--bc-kb-inset,0px))!important;padding-bottom:8px!important;overflow-y:auto!important;-webkit-overflow-scrolling:touch!important}
            ...
            .bc-row-icon{font-size:18px!important;margin-bottom:0!important;display:flex!important;align-items:center!important;justify-content:center!important}
            .bc-row-icon svg{width:18px!important;height:18px!important;display:block!important;stroke:currentColor!important;fill:none!important}
            ...
            .bc-kb-open .bc-input-container{min-height:0!important;max-height:calc(100dvh - 120px - var(--bc-kb-inset,0px))!important}
            .bc-kb-open .bc-textarea{min-height:96px!important;height:auto!important;max-height:calc(100dvh - 160px - var(--bc-kb-inset,0px))!important}
            .bc-kb-open .bc-capsule-input-box{min-height:0!important;max-height:calc(100dvh - 120px - var(--bc-kb-inset,0px))!important}
            .bc-kb-open .bc-capsule-textarea{min-height:96px!important;height:auto!important;max-height:calc(100dvh - 160px - var(--bc-kb-inset,0px))!important}
        }
        /* 捕捉与 Moments 速记胶囊共用：强制顶对齐 */
        .bc-mobile-force-top .modal-container{align-items:flex-start!important;justify-content:center!important;padding-top:0!important;padding-bottom:max(8px,var(--bc-kb-inset,0px))!important;padding-left:0!important;padding-right:0!important}
        .bc-mobile-force-top .bc-modal-container,
        .bc-mobile-force-top .bc-capsule-modal{width:96%!important;max-width:96%!important;height:fit-content!important;min-height:0!important;flex:0 0 auto!important;margin:48px auto 8px!important;box-sizing:border-box!important;left:auto!important;right:auto!important;max-height:calc(100vh - 56px - var(--bc-kb-inset,0px))!important;max-height:calc(100dvh - 56px - var(--bc-kb-inset,0px))!important;padding-bottom:8px!important;overflow-y:auto!important;-webkit-overflow-scrolling:touch!important}
        ...
        .bc-mobile-force-top .bc-row-icon{font-size:18px!important;display:flex!important;align-items:center!important;justify-content:center!important}
        .bc-mobile-force-top .bc-row-icon svg{width:18px!important;height:18px!important;display:block!important}
        ...
        .bc-mobile-force-top .bc-modal-container .modal-close-button,
        .bc-mobile-force-top .bc-capsule-modal .modal-close-button,
        .bc-mobile-force-top .bc-material-dialog .modal-close-button{top:6px!important;right:6px!important;width:32px!important;height:32px!important;transform:none!important;opacity:.55!important;display:flex!important;align-items:center!important;justify-content:center!important;box-sizing:border-box!important;background:transparent!important;box-shadow:none!important;border:0!important}
        .bc-mobile-force-top .bc-kb-open .bc-input-container,.bc-mobile-force-top .bc-modal-container.bc-kb-open .bc-input-container{min-height:228px!important}
        .bc-mobile-force-top .bc-kb-open .bc-textarea,.bc-mobile-force-top .bc-modal-container.bc-kb-open .bc-textarea{min-height:228px!important;height:228px!important}
        .bc-mobile-force-top .bc-kb-open .bc-capsule-input-box,.bc-mobile-force-top .bc-capsule-modal.bc-kb-open .bc-capsule-input-box{min-height:300px!important}
        .bc-mobile-force-top .bc-kb-open .bc-capsule-textarea,.bc-mobile-force-top .bc-capsule-modal.bc-kb-open .bc-capsule-textarea{min-height:300px!important;height:300px!important}`;
...
function renderBrainCoreMomentsSettingsPanel(containerEl, plugin, tab) {
    ...
    basicCard.createEl('h3', { text: '✨ Moments' });
    ...
    footCard.createEl('h3', { text: '打开 Moments' });
...
class BrainCoreSettingsTab extends PluginSettingTab {
    ...
    display() {
        ...
        pathsCard.createEl('h4', { text: '第三方联动（可选）' });
...
class BrainCoreIOSQuickModal extends Modal {
    ...
    injectQuickStyle() {
        ...
        if (!document.getElementById("bc-capture-modal-styles-v274")) {
        ...
        style.textContent = `
            ...
            .bcq-capture-shell .bc-row-item.is-active {
                background: var(--lifeos-accent-soft, rgba(180, 130, 70, 0.12)) !important;
                opacity: 1 !important;
            }
            ...
            .bcq-capture-shell .bc-row-icon svg {
                width: 18px !important;
                height: 18px !important;
...
.sb-task-children .sb-task-children .sb-task-text{font-size:.84em!important;opacity:.88}.sb-quote-wrap{padding:4px 0 2px 12px!important;background:0 0;border-left:3.5px solid color-mix(in srgb, var(--lifeos-accent, #b48246) 42%, transparent);margin:6px 2px 0!important;position:relative}.sb-quote-content{font-size:.92em;line-height:1.75;letter-spacing:.02em;color:#6b5b4d;font-weight:500;margin-bottom:2px!important;margin-top:0!important;text-align:justify;-webkit-user-select:text;user-select:text;transition:opacity .12s ease}.sb-quote-src{font-size:.78em;color:var(--text-muted);text-align:right;font-weight:600;opacity:.55;margin:0!important;letter-spacing:.01em}.sb-quote-wrap.is-cycling .sb-quote-content,.sb-quote-wrap.is-cycling .sb-quote-src{opacity:.35}.sb-empty-state{text-align:center;font-size:13px;color:var(--text-muted);margin:2px 0!important;padding:12px 8px}.sb-stat-item-wrap{display:flex;justify-content:space-between;align-items:center;padding:2px 8px;border-radius:6px;cursor:pointer;transition:all .2s cubic-bezier(.25,.8,.25,1)}@media (hover:hover){.sb-stat-item-wrap:hover{background:color-mix(in srgb, var(--lifeos-accent, #b48246) 8%, transparent);transform:translateY(-1px)}}.sb-stat-item-wrap:active{transform:scale(.95);background:color-mix(in srgb, var(--lifeos-accent, #b48246) 12%, transparent)}.sb-stat-total-row{align-items:flex-end;margin-bottom:0!important;margin-top:0!important}.sb-stat-table{width:100%!important;border-collapse:collapse;border:none;margin-bottom:2px!important;margin-top:0!important}.sb-stat-cell{border:none!important;padding:0!important}.sb-stat-val{color:var(--text-accent);font-weight:800;font-size:16px!important;pointer-events:none}.sb-stat-item-wrap span:first-child{font-size:14px!important;color:var(--text-muted);pointer-events:none}
        .sb-btn-wrapper{grid-template-columns:repeat(4,minmax(0,1fr))!important;align-items:start!important}.sb-btn{-webkit-appearance:none!important;appearance:none!important;display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:flex-start!important;gap:2px!important;width:100%!important;min-width:0!important;height:auto!important;min-height:0!important;padding:0!important;border:0!important;border-radius:0!important;background:transparent!important;box-shadow:none!important;color:inherit!important;font:inherit!important;line-height:1!important;overflow:visible!important}.sb-btn:hover,.sb-btn:focus,.sb-btn:active{background:transparent!important;border:0!important;box-shadow:none!important}.sb-btn-box{width:min(100%,52px)!important;box-sizing:border-box!important;flex:0 0 auto!important}.sb-btn-name{display:block!important;position:static!important;width:100%!important;min-width:0!important;margin:0!important;line-height:1.2!important;text-align:center!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}
        .sb-btn,.sb-btn-box,.sb-box,.sb-habit-drag,.sb-task-checkbox,.sb-tip-icon{-webkit-user-select:none;user-select:none}
        @media (prefers-reduced-motion: reduce){.sb-task-item,.sb-box,.sb-btn-box,.sb-pixel-bar-fill,.sb-quote-content,.sb-quote-src,.sb-stat-item-wrap{transition:none!important;animation:none!important;transform:none!important}.sb-quote-wrap.is-cycling .sb-quote-content,.sb-quote-wrap.is-cycling .sb-quote-src{opacity:1!important}}
